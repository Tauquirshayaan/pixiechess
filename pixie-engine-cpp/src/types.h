...
// ============================================================
// RESEARCH PLATFORM FEATURE FLAGS
// ============================================================
#define ENABLE_EVAL_DASHBOARD
#define ENABLE_COUNTERFACTUAL
#define ENABLE_ATTRIBUTION
#define ENABLE_SEARCH_STATS
...
enum PieceType {
    ...
    // 8 Pixie Pawns
    GOLDEN_PAWN, IRONPAWN, EPEE_PAWN, PAWN_KNIFE, HERO_PAWN, SHRIKE, WARP_JUMPER, WAR_AUTOMATON,
    // 6 Pixie Knights
    ELECTROKNIGHT, BANKER, CAMEL, KNIGHTMARE, ANTI_VIOLENCE, FISH_KNIGHT,
    // 12 Pixie Bishops
