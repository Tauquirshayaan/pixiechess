...
export default function ChessSquare({
  ...
  return (
    ...
    >
      {/* ── Green glow border — last-move from-square ── */}
      {isGlowFrom && (
        <div style={{
          position: 'absolute',
          inset: 0,
          boxShadow: 'inset 0 0 0 3px rgba(74,222,128,0.7), 0 0 12px 3px rgba(74,222,128,0.4)',
          pointerEvents: 'none',
          zIndex: 1,
          borderRadius: 1,
        }} />
      ...
      {/* ── Green glow border — last-move to-square ── */}
      {isGlowTo && (
        <div style={{
          position: 'absolute',
          inset: 0,
