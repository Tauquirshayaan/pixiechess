...
const TABS = ['Pawn', 'Knight', 'Bishop', 'Rook', 'Queen'] as const;
...
export default function PlacementPalette({ hoveredBoardPiece }: { hoveredBoardPiece?: Piece | null }) {
  ...
  return (
    <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 10, padding: 12, display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
      ...
      {(() => {
        ...
        if (hoveredBoardPiece && hoveredBoardPiece.pixie) {
          const pixieType = hoveredBoardPiece.pixie;
