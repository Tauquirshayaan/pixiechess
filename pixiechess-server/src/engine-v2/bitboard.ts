...
export function emptyBitboardState(): BitboardState {
  return {
    ...
    whiteRooks: ZERO, whiteCastlingRooks: ZERO, whiteQueens: ZERO, whiteKing: ZERO, whitePixies: ZERO,
    blackPawns: ZERO, blackKnights: ZERO, blackBishops: ZERO,
    blackRooks: ZERO, blackCastlingRooks: ZERO, blackQueens: ZERO, blackKing: ZERO, blackPixies: ZERO,
    activePixies: [],
...
export function cloneBB(s: BitboardState): BitboardState {
  return {
    ...
    whiteRooks: s.whiteRooks, whiteCastlingRooks: s.whiteCastlingRooks, whiteQueens: s.whiteQueens, whiteKing: s.whiteKing, whitePixies: s.whitePixies,
    blackPawns: s.blackPawns, blackKnights: s.blackKnights, blackBishops: s.blackBishops,
    blackRooks: s.blackRooks, blackCastlingRooks: s.blackCastlingRooks, blackQueens: s.blackQueens, blackKing: s.blackKing, blackPixies: s.blackPixies,
