import { getAllMovesForColor, isCheck } from './src/engine/moveGenerator';
import type { GameState, Board } from './src/engine/types';
...
b[6][6] = {type:'P', color:'w', pixie:'WAR_AUTOMATON', id:'99', state:{}}; // g2
...
// Black pieces
b[6][7] = {type:'B', color:'b', pixie:'BOUNCER', id:'7', state:{}}; // h2
